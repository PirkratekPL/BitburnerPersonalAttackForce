...
export interface TIX {
   ...
   * @param export type - Type of order.
...
/**
 * Base export interface of all tasks.
 *
 * @public
 */
...
export interface Singularity {
   ...
   * if (!success) ns.tprint(`ERROR: Failed to start work for ${factionName} with work export type ${workType}.`);
   * ```
   ...
   *
   * The specified faction must offer at least 1 export type of work. You can use {@link Singularity.getFactionWorkTypes | getFactionWorkTypes} to get the list of work types of a faction.
   *
...
/**
 * Skill names export type of Bladeburner
 *
 * @public
 */
...
export interface Bladeburner {
   ...
   * ```
   *
   * @param export type - Type of action.
   ...
   * You can also pass the export type and name of an action to get the number of
...
export interface CodingContract {
  ...
  /**
   * Get the export type of a coding contract.
   * @remarks
   * RAM cost: 5 GB
   *
   * Returns a name describing the export type of problem posed by the Coding Contract.
   * (e.g. Find Largest Prime Factor, Total Ways to Sum, etc.)
   *
   * @param filename - Filename of the contract.
   * @param host - Hostname of the server containing the contract. Optional. Defaults to current server if not provided.
   * @returns Name describing the export type of problem posed by the Coding Contract.
   */
   ...
   * @returns The specified contract’s data, data export type depends on contract type.
   */
   ...
   * Depending on the export type of the contract, the data is typed differently.
   * Using type-narrowing, you can get the correct export type of the data:
   *
   * @example
   * ```js
   * const contract = ns.codingcontract.getContract(fileName, hostName);
   * if (contract.export type === ns.enums.CodingContractName.FindLargestPrimeFactor) {
   ...
   *
   * @param export type - Type of contract to generate
...
export interface Gang {
  ...
  /**
   * Get export type of an equipment.
   * @remarks
   * RAM cost: 2 GB
   *
...
export interface Sleeve {
   ...
   * property, and other available properties depend on the export type of task.
   *
...
export interface NS {
   ...
   * RAM cost: 0 GB
   *
   * See {@link ReactNode} export type for the acceptable values.
   *
   ...
   * export type except message (.msg) files.
   *
   ...
   *   Choosing export type `"select"` will require an array to be passed via the
 ...
 * @public
 */
export declare enum UniversityLocationName {
 ...
 * @public
 */
export declare enum GymLocationName {
...
export interface Corporation extends WarehouseAPI, OfficeAPI {
   ...
   *
   * - The specified faction must offer at least 1 export type of work. You can use
...
export interface IndustryData {
  /** Industry export type */
  type: CorpIndustryName;
  /** Cost to make a new division of this industry export type */
  cost: number;
...
export interface AutocompleteData {
   ...
   *
   * For example, if you export type `[Space]run test.js[Space][Space][Space][Press tab to use autocomplete]`, "command" will
